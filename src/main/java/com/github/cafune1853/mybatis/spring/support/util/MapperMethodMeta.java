...
public final class MapperMethodMeta {
	...
	private MapperMethodMeta(Class<?> entityClazz, boolean appendClazzAsArg, boolean autoResultMap, List<ResultMap> resultMaps, boolean setKeyPropertiesAndColumns, String keyProperty, String keyColumn) {
	...
	private static MapperMethodMeta buildMapperMeta(Configuration configuration, String mapperClassName, String mapperMethodName) throws ClassNotFoundException{
		...
		if(method.isAnnotationPresent(SetKeyPropertiesAndColumns.class)){
			...
			EntityMeta entityMeta = EntityMeta.getPersistenceEntityMeta(getEntityClassByMapperClass(mapperClazz));
	...
	private static ResultMap getResultMap(Configuration configuration, Class<?> entityClazz, String mapperResultId) {
		...
		EntityMeta entityMeta = EntityMeta.getPersistenceEntityMeta(entityClazz);
